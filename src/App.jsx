    ...
    <div className="flex flex-col min-h-screen bg-black text-white" style={{ overflow: "hidden" }}>
      {selectedCity && showBackButton && (
        <button
          ...
          className={
                  `fixed right-4 text-white text-xl font-bold px-4 py-2 rounded-xl shadow-lg transition-all bg-white/10 hover:bg-white/20 duration-200 z-[101] ` +
                  (showNavbar
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center pointer-events-auto">
            ...
            {showBackButton && (
              <button
                ...
                className={
                  `fixed left-6 text-white text-xl font-bold px-4 py-2 rounded-xl shadow-lg transition-all bg-white/20 hover:bg-white/40 duration-200 z-[101] ` +
                  (showNavbar
                    ? 'top-24 backdrop-blur bg-black/60 border border-white/10 hover:bg-black/80'
                    : 'top-6 backdrop-blur bg-black/60 border border-white/10 hover:bg-black/80')
                }
